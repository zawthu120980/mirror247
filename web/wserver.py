    ...
    <header>
      <div class="brand">
        <img
          ...
          alt="logo"
        />
        <a href="https://t.me/mirror_247_chennel">
          <h2 class="name">Qbittorrent Selection</h2>
        </a>
      </div>
      <div class="Channel">
        <a href="https://t.me/mirror_247_chennel"><i class="fab fa-github"></i></a>
        <a href="https://t.me/mirror_247_chennel"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <div id="sticks">
